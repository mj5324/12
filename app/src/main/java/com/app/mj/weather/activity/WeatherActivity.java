...
public class WeatherActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
       ...
       Log.e("activity启动的时候，queryAndSaveAndShow()","查询+保存+展示");
...
//   天气信息： 查询+保存+UI展示
    ...
    private void showWeather() {
        ...
        String curTime= String.valueOf(mHour)+":"+String.valueOf(mMinuts)+":"+String.valueOf(mSec);
        ...
        publishText.setText("刷新时间"+curTime);
